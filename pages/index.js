...
export default function Home() {
  ...
  const contractAddress = "0xF112dE731f4Bb9C6EdB77A9E2A9cf8ec303c41b8";  //contract address
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <title>Buy Kevin a Coffee!</title>
            ...
            <form>
              <div class="formgroup">
                ...
                <input
                  id="name"
                  type="text"
                  placeholder="Entre the name here"
